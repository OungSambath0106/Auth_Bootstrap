                        ...
                        <div class="row">
                            <div class="col-6">
                                <fieldset>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="password" class="form-control" style=" color: #3559E0;">
                                        @error('password')
                                            <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-6">
                                                    ...
                                                    <div class="custom-file mx-2">
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <img id="profileImage" style="border-radius: 10px;"
                                                                class="mx-5" width="180" height="180"
                                ...
                                <div class="form-check form-switch mt-3">
                                    <input name="ishidden" class="form-check-input" type="checkbox" role="switch" style=" border-color: #3559E0;"
